...
static void do_pwd (session_t *sess)
{
	...
	getcwd(buffer, MAX_BUFFER_SIZE);   //  /home/do
	char msg[MAX_BUFFER_SIZE] = {0};
	sprintf(msg, "\"%s\"", buffer);    //  "/home/do"
...
static void do_mkd (session_t *sess)
{
	...
	//257 "/home/do/abc/test.txt" created
	char buf[MAX_BUFFER_SIZE] = {0};
...
static void do_retr(session_t *sess)
{
	...
	else
	{
		...
		// 150 Opening ASCII mode data connection for /home/do/abc/test.cpp (70 bytes).
